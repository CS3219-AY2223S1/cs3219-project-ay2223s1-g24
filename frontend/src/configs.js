...
export const MATCHING_SERVICE_SOCKET_ENDPOINT = "http://matching-service-dev.ap-southeast-1.elasticbeanstalk.com/";
// export const MATCHING_SERVICE_SOCKET_ENDPOINT = "http://localhost:8080";

export const COLLABORATION_SERVICE_SOCKET_ENDPOINT = "http://collaboration-service-dev.ap-southeast-1.elasticbeanstalk.com/";
